    ...
    <div class="col-6  mx-auto mt-3">
      ...
      <form name="form1" onsubmit="sendData(event)" novalidate>
        ...
        <div class="mb-3">
          ...
          <!-- <input type="file" class="form-control" id="prod_img" accept="image/*" name="prod_img"  required> -->
          <input type="text" class="form-control" id="prod_img" name="prod_img" hidden required>
          <div class="form-text"></div>
        </div>
        <div class="mb-3">
