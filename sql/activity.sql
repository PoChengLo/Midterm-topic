...
(1, 'Basketball Game', '2024-07-10', 1, 'Sports', '2024-07-01 10:00:00', 'Friendly match at the local gym'),
(2, 'Coding Workshop', '2024-07-15', 2, 'Education', '2024-07-02 11:00:00', 'Introduction to PHP programming'),
...
(5, 'Yoga Class', '2024-07-30', 5, 'Health', '2024-07-05 14:00:00', 'Morning yoga session');
...
--
ALTER TABLE `actlist`
  MODIFY `act_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
