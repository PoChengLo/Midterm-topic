...
<body>
  <div class="container">
    ...
    <div class="pagination">
      <?php if ($page > 1) { ?>
        <a class="but003" href="index.php?page=<?php echo $page - 1; ?>&search_name=<?php echo urlencode($search_name); ?>&search_date_start=<?php echo urlencode($search_date_start); ?>&search_date_end=<?php echo urlencode($search_date_end); ?>">上一頁</a>
      <?php } ?>

      <?php for ($i = 1; $i <= $total_pages; $i++) { ?>
        <a class="but003" href="index.php?page=<?php echo $i; ?>&search_name=<?php echo urlencode($search_name); ?>&search_date_start=<?php echo urlencode($search_date_start); ?>&search_date_end=<?php echo urlencode($search_date_end); ?>"><?php echo $i; ?></a>
      <?php } ?>

      <?php if ($page < $total_pages) { ?>
        <a class="but003" href="index.php?page=<?php echo $page + 1; ?>&search_name=<?php echo urlencode($search_name); ?>&search_date_start=<?php echo urlencode($search_date_start); ?>&search_date_end=<?php echo urlencode($search_date_end); ?>">下一頁</a>
      <?php } ?>
    </div>
    <br>
  </div>
